...
def main(rec, gt = "groundtruth_scene_1_130", framerate = 25, x_min=-100, x_max=2200, offset=0, duration=90, 
...
# "young_ox--RAW_GT2__calibrates"
    main(rec = "sanctimonious_beluga--RAW_GT1__test", save=False, upload = True, offset = 0, transform=False, extra="")
