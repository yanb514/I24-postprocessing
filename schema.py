...
RAW_SCHEMA = {
    "$jsonSchema": {
        "bsonType": "object",
        "required": ["configuration_id", "timestamp", "last_timestamp", "x_position"], # TODO: all fields should be required
        "properties": {
            "configuration_id": {
                "bsonType": "int",
            ...
            "local_fragment_id": {
                "bsonType": "int",
                "description": "Integer unique to each tracked vehicle per compute_node_ID and configuration_ID, generated by the tracker"
                },
            "compute_node_id": {
                "bsonType": "int",
                "description": "The generating tracker’s unique compute node id. Roughly, it maps to what hardware was used to generate the trajectory fragment"
                },
            ...
            "raw_timestamp": {
                ...
                "description": "Raw timestamps from video frames as reported by the camera. This may contain bias or other errors."
                },
            "first_timestamp": {
                "bsonType": ["int", "double"],
    ...
    "$jsonSchema": {
        ...
        "properties": {
            ...
            "fragment_ids": {
                ...
                "description": "list of indices pointing to fragment IDs associated to current vehicle ID, sorted by start_timestamp"
                },
            }
        }
    }
