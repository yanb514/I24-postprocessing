...
def live_data_reader(default_param, east_queue, west_queue, t_buffer = 1, min_queue_size = 1000, read_from_simulation = True):
    """
    ...
    ** NEEDS TO DETERMINE **
    ...
    #     while stream.alive and sig_hdlr.run: # stream will die if there's a short pause in database insert
