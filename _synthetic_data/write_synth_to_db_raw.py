...
def write_raw_to_db(db_param, write_db, write_col, GTFilePath):
...
if __name__ == "__main__":
    ...
    GTFilePath = "/Volumes/Elements/GT/23-34min.csv"
    ...
    # write_raw_to_db(db_param, "transmodeler", "groundtruth_23_34", GTFilePath)
